...
class PDFProcessor:
    ...
    def get_relevant_documents(self, query: str, k: int = 14) -> List[Dict]:
        """
        Retrieve relevant documents for a query without separating by document type.
        ...
        try:
            # Search all documents without filtering by type
